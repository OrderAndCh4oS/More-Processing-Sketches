...
void setup() {
  PImage img = loadImage("14-breathtaking-black-and-white-animal-photos-8.jpg");
  background(#FCFEF7);
  size(1200, 1200);
  for (int i = 0; i < 1200/12; i++) {
    for (int j = 0; j < 1200/12; j++) {
      PImage newImg = img.get(i*12, j*12, 12, 12);
